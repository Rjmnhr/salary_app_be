...
const notifyByMailFileUpload = (data) => {
  const {
    name,
    email,
    phone,
...
We are pleased to inform you that a customer has submitted Salary Survey and Uploaded the Excel File. Below are the details of the  customer:
...
We are pleased to inform you that a customer has submitted their details for the salary survey. Below are the details of the  customer:
...
const SurveyController = {
  uploadExcel: async (req, res) => {
    try {
      ...
      if (result) {
        notifyByMailFileUpload(req.body);
      }
